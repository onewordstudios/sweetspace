...
//  Version: 6/11/18
//
#ifndef __CU_TWO_ZERO_FIR_H__
#define __CU_TWO_ZERO_FIR_H__
 ...
 *
 * This is the simplest class for implementing a "notch" in a frequency while
 * maintaining a constant filter gain. There is a convenience method for
 * defining this notch. However, filters are not intended to be model classes,
...
#pragma mark IIR Signature
     ...
     * Similarly, all b-coefficients after the third are ignored. If any
