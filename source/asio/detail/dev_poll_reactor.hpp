...
class dev_poll_reactor : public execution_context_service_base<dev_poll_reactor> {
   public:
	...
	ASIO_DECL int register_internal_descriptor(int op_type, socket_type descriptor,
	...
	ASIO_DECL void start_op(int op_type, socket_type descriptor, per_descriptor_data&,
	...
	ASIO_DECL void deregister_descriptor(socket_type descriptor, per_descriptor_data&,
										 bool closing);
