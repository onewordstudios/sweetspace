...
auto zero_arg_copyable_handler_test(Handler h, void*)
	-> decltype(sizeof(Handler(static_cast<const Handler&>(h))), ((h)()), char(0));
...
auto one_arg_handler_test(Handler h, Arg1* a1)
	-> decltype(sizeof(Handler(ASIO_MOVE_CAST(Handler)(h))), ((h)(*a1)), char(0));
...
auto two_arg_handler_test(Handler h, Arg1* a1, Arg2* a2)
	-> decltype(sizeof(Handler(ASIO_MOVE_CAST(Handler)(h))), ((h)(*a1, *a2)), char(0));
...
auto two_arg_move_handler_test(Handler h, Arg1* a1, Arg2* a2)
	-> decltype(sizeof(Handler(ASIO_MOVE_CAST(Handler)(h))), ((h)(*a1, ASIO_MOVE_CAST(Arg2)(*a2))),
				char(0));
...
#define ASIO_ACCEPT_HANDLER_CHECK(handler_type, handler)                                          \
	...
	typedef ASIO_HANDLER_TYPE(handler_type, void(asio::error_code)) asio_true_handler_type;       \
                                                                                                  \
	ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT(                                                        \
		sizeof(asio::detail::one_arg_handler_test(asio::detail::rvref<asio_true_handler_type>(),  \
...
#define ASIO_RANGE_CONNECT_HANDLER_CHECK(handler_type, handler, endpoint_type)                   \
                                                                                                 \
	typedef ASIO_HANDLER_TYPE(handler_type, void(asio::error_code, endpoint_type))               \
		asio_true_handler_type;                                                                  \
                                                                                                 \
	ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT(                                                       \
		sizeof(asio::detail::two_arg_handler_test(asio::detail::rvref<asio_true_handler_type>(), \
...
#define ASIO_SIGNAL_HANDLER_CHECK(handler_type, handler)                                          \
	...
	typedef asio::detail::handler_type_requirements<                                              \
		sizeof(asio::detail::argbyv(asio::detail::rvref<asio_true_handler_type>())) +             \
		sizeof(                                                                                   \
			asio::detail::lvref<asio_true_handler_type>()(                                        \
