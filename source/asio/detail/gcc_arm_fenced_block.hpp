...
class gcc_arm_fenced_block : private noncopyable {
   public:
	...
	explicit gcc_arm_fenced_block(full_t) { barrier(); }

	// Destructor.
	~gcc_arm_fenced_block() { barrier(); }

   private:
	static void barrier() {
#if defined(__ARM_ARCH_4__) || defined(__ARM_ARCH_4T__) || defined(__ARM_ARCH_5__) ||    \
	...
	defined(__ARM_ARCH_6T2__)
		...
		int a = 0, b = 0;
		__asm__ __volatile__("swp %0, %1, [%2]" : "=&r"(a) : "r"(1), "r"(&b) : "memory", "cc");
