...
class reactive_socket_send_op_base : public reactor_op {
   public:
	reactive_socket_send_op_base(socket_type socket, socket_ops::state_type state,
	...
	static status do_perform(reactor_op* base) {
		...
		if (result == done)
			if ((o->state_ & socket_ops::stream_oriented) != 0)
				if (o->bytes_transferred_ < bufs.total_size()) result = done_and_exhausted;
...
class reactive_socket_send_op : public reactive_socket_send_op_base<ConstBufferSequence> {
   public:
	...
	reactive_socket_send_op(socket_type socket, socket_ops::state_type state,
		...
		: reactive_socket_send_op_base<ConstBufferSequence>(socket, state, buffers, flags,
