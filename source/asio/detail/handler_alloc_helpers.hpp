...
class hook_allocator {
   public:
	...
	T* allocate(std::size_t n) {
		return static_cast<T*>(asio_handler_alloc_helpers::allocate(sizeof(T) * n, handler_));
	}
...
#define ASIO_DEFINE_HANDLER_PTR(op)                                                             \
	struct ptr {                                                                                \
		...
		static op* allocate(Handler& handler) {                                                 \
			typedef                                                                             \
				typename ::asio::associated_allocator<Handler>::type associated_allocator_type; \
			...
			a(::asio::detail::get_hook_allocator<Handler, associated_allocator_type>::get(      \
...
#define ASIO_DEFINE_TAGGED_HANDLER_ALLOCATOR_PTR(purpose, op)                                  \
	struct ptr {                                                                               \
		...
		static op* allocate(const Alloc& a) {                                                  \
			typedef typename ::asio::detail::get_recycling_allocator<Alloc, purpose>::type     \
