...
class resolve_endpoint_op : public resolve_op {
   public:
	...
	resolve_endpoint_op(socket_ops::weak_cancel_token_type cancel_token,
						const endpoint_type& endpoint, scheduler_impl& sched, Handler& handler,
	...
	static void do_complete(void* owner, operation* base, const asio::error_code& /*ec*/,
		...
		if (owner && owner != &o->scheduler_) {
			...
			socket_ops::background_getnameinfo(
				o->cancel_token_, o->endpoint_.data(), o->endpoint_.size(), host_name, NI_MAXHOST,
				service_name, NI_MAXSERV, o->endpoint_.protocol().type(), o->ec_);
