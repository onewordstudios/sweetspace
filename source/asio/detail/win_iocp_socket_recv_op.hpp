...
class win_iocp_socket_recv_op : public operation {
   public:
	...
	static void do_complete(void* owner, operation* base, const asio::error_code& result_ec,
		...
		if (owner) {
			buffer_sequence_adapter<asio::mutable_buffer, MutableBufferSequence>::validate(
				o->buffers_);
		}
#endif // defined(ASIO_ENABLE_BUFFER_DEBUGGING)

		socket_ops::complete_iocp_recv(
			o->state_, o->cancel_token_,
		...
		detail::binder2<Handler, asio::error_code, std::size_t> handler(o->handler_, ec,
																		bytes_transferred);
