...
class winrt_ssocket_service
   ...
   public:
	...
	struct implementation_type : base_implementation_type {
		// Default constructor.
		implementation_type() : base_implementation_type(), protocol_(endpoint_type().protocol()) {}
	...
	void move_assign(implementation_type& impl, winrt_ssocket_service& other_service,
	...
	void converting_move_construct(
		implementation_type& impl, winrt_ssocket_service<Protocol1>&,
	...
	asio::error_code get_option(const implementation_type& impl, Option& option,
		...
		do_get_option(impl, option.level(impl.protocol_), option.name(impl.protocol_),
