...
class reactive_descriptor_service
   ...
   public:
	...
	asio::error_code io_control(implementation_type& impl, IO_Control_Command& command,
								asio::error_code& ec) {
	...
	asio::error_code wait(implementation_type& impl, posix::descriptor_base::wait_type w,
						  asio::error_code& ec) {
		switch (w) {
	...
	void async_wait(implementation_type& impl, posix::descriptor_base::wait_type w,
		...
		ASIO_HANDLER_CREATION(
			(reactor_.context(), *p.p, "descriptor", &impl, impl.descriptor_, "async_wait"));
	...
	size_t write_some(implementation_type& impl, const ConstBufferSequence& buffers,
		...
		return descriptor_ops::sync_write(impl.descriptor_, impl.state_, bufs.buffers(),
										  bufs.count(), bufs.all_empty(), ec);
	}
	...
	void async_write_some(implementation_type& impl, const ConstBufferSequence& buffers,
		...
		ASIO_HANDLER_CREATION(
			(reactor_.context(), *p.p, "descriptor", &impl, impl.descriptor_, "async_write_some"));
	...
	void async_write_some(implementation_type& impl, const null_buffers&, Handler& handler,
		...
		ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "descriptor", &impl, impl.descriptor_,
	...
	size_t read_some(implementation_type& impl, const MutableBufferSequence& buffers,
		...
		return descriptor_ops::sync_read(impl.descriptor_, impl.state_, bufs.buffers(),
										 bufs.count(), bufs.all_empty(), ec);
	}
	...
	void async_read_some(implementation_type& impl, const MutableBufferSequence& buffers,
		...
		ASIO_HANDLER_CREATION(
			(reactor_.context(), *p.p, "descriptor", &impl, impl.descriptor_, "async_read_some"));
   ...
   private:
	...
	ASIO_DECL void start_op(implementation_type& impl, int op_type, reactor_op* op,
