...
char (&buffer_sequence_begin_helper(
	T* t, typename enable_if<
			  !is_same<decltype(asio::buffer_sequence_begin(*t)), void>::value>::type*))[2];
...
template <typename T>
char buffer_sequence_begin_helper(
	T* t, buffer_sequence_memfns_check<void (buffer_sequence_memfns_base::*)(),
...
char (&buffer_sequence_end_helper(
	T* t,
	typename enable_if<!is_same<decltype(asio::buffer_sequence_end(*t)), void>::value>::type*))[2];
...
template <typename T>
char size_memfn_helper(buffer_sequence_memfns_check<void (buffer_sequence_memfns_base::*)(),
...
template <typename T>
char data_memfn_helper(buffer_sequence_memfns_check<void (buffer_sequence_memfns_base::*)(),
...
template <typename T>
char commit_memfn_helper(buffer_sequence_memfns_check<void (buffer_sequence_memfns_base::*)(),
...
template <typename T>
char grow_memfn_helper(buffer_sequence_memfns_check<void (buffer_sequence_memfns_base::*)(),
...
template <typename T>
char shrink_memfn_helper(buffer_sequence_memfns_check<void (buffer_sequence_memfns_base::*)(),
...
char buffer_sequence_element_type_helper(
	T* t, typename enable_if<
			  is_convertible<decltype(*asio::buffer_sequence_begin(*t)), Buffer>::value>::type*);
...
char buffer_sequence_element_type_helper(
	...
	typename enable_if<is_convertible<typename T::value_type, Buffer>::value>::type*);
...
struct is_buffer_sequence
	: conditional<is_class<T>::value, is_buffer_sequence_class<T, Buffer>, false_type>::type {};
