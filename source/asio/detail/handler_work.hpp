...
template <typename Handler, typename IoExecutor = system_executor,
		  typename HandlerExecutor = typename associated_executor<Handler, IoExecutor>::type>
class handler_work {
   public:
	...
	static void start(Handler& handler, const IoExecutor& io_ex) ASIO_NOEXCEPT {
