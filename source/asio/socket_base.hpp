...
#else
	typedef asio::detail::socket_option::boolean<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_BROADCAST)>
		broadcast;
#endif
...
#else
	typedef asio::detail::socket_option::boolean<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_DEBUG)>
		debug;
#endif
...
#else
	typedef asio::detail::socket_option::boolean<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_DONTROUTE)>
		do_not_route;
#endif
...
#else
	typedef asio::detail::socket_option::boolean<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_KEEPALIVE)>
		keep_alive;
#endif
...
#else
	typedef asio::detail::socket_option::integer<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_SNDBUF)>
		send_buffer_size;
#endif
...
#else
	typedef asio::detail::socket_option::integer<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_SNDLOWAT)>
		send_low_watermark;
#endif
...
#else
	typedef asio::detail::socket_option::integer<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_RCVBUF)>
		receive_buffer_size;
#endif
...
#else
	typedef asio::detail::socket_option::boolean<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_REUSEADDR)>
		reuse_address;
#endif
...
#else
	typedef asio::detail::socket_option::linger<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_LINGER)>
		linger;
#endif
...
#else
	typedef asio::detail::socket_option::boolean<ASIO_OS_DEF(SOL_SOCKET), ASIO_OS_DEF(SO_OOBINLINE)>
		out_of_band_inline;
#endif
