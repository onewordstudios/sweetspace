...
class mutable_buffer {
   public:
	...
	mutable_buffer(void* data, std::size_t size) ASIO_NOEXCEPT : data_(data), size_(size) {}
...
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
		if (size_ && debug_check_) debug_check_();
#endif // ASIO_ENABLE_BUFFER_DEBUGGING
		return data_;
	}

	/// Get the size of the memory range.
	std::size_t size() const ASIO_NOEXCEPT { return size_; }
...
class mutable_buffers_1 : public mutable_buffer {
   public:
	...
	mutable_buffers_1(void* data, std::size_t size) ASIO_NOEXCEPT : mutable_buffer(data, size) {}
	...
	explicit mutable_buffers_1(const mutable_buffer& b) ASIO_NOEXCEPT : mutable_buffer(b) {}

	/// Get a random-access iterator to the first element.
	const_iterator begin() const ASIO_NOEXCEPT { return this; }

	/// Get a random-access iterator for one past the last element.
	const_iterator end() const ASIO_NOEXCEPT { return begin() + 1; }
};
...
class const_buffer {
   public:
	...
	/// Construct a buffer to represent a given memory range.
	const_buffer(const void* data, std::size_t size) ASIO_NOEXCEPT : data_(data), size_(size) {}

	/// Construct a non-modifiable buffer from a modifiable one.
	const_buffer(const mutable_buffer& b) ASIO_NOEXCEPT : data_(b.data()),
														  size_(b.size())
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
		,
...
class const_buffers_1 : public const_buffer {
   public:
	...
	/// Construct to represent a given memory range.
	const_buffers_1(const void* data, std::size_t size) ASIO_NOEXCEPT : const_buffer(data, size) {}
	...
	explicit const_buffers_1(const const_buffer& b) ASIO_NOEXCEPT : const_buffer(b) {}
...
class null_buffers {
   public:
	...
	/// Get a random-access iterator to the first element.
	const_iterator begin() const ASIO_NOEXCEPT { return &buf_; }

	/// Get a random-access iterator for one past the last element.
	const_iterator end() const ASIO_NOEXCEPT { return &buf_; }
...
inline const mutable_buffer* buffer_sequence_begin(
	...
	typename enable_if<is_convertible<const MutableBuffer*, const mutable_buffer*>::value>::type* =
		0) ASIO_NOEXCEPT {
...
inline auto buffer_sequence_begin(
	C& c, typename enable_if<!is_convertible<const C*, const mutable_buffer*>::value &&
							 !is_convertible<const C*, const const_buffer*>::value>::type* = 0)
	ASIO_NOEXCEPT -> decltype(c.begin()) {
	return c.begin();
}
...
template <typename C>
inline auto buffer_sequence_begin(
	const C& c, typename enable_if<!is_convertible<const C*, const mutable_buffer*>::value &&
								   !is_convertible<const C*, const const_buffer*>::value>::type* =
					0) ASIO_NOEXCEPT -> decltype(c.begin()) {
	return c.begin();
}
...
template <typename C>
inline typename C::iterator buffer_sequence_begin(
	C& c, typename enable_if<!is_convertible<const C*, const mutable_buffer*>::value &&
							 !is_convertible<const C*, const const_buffer*>::value>::type* = 0)
	ASIO_NOEXCEPT {
	return c.begin();
...
template <typename C>
inline typename C::const_iterator buffer_sequence_begin(
	const C& c, typename enable_if<!is_convertible<const C*, const mutable_buffer*>::value &&
								   !is_convertible<const C*, const const_buffer*>::value>::type* =
					0) ASIO_NOEXCEPT {
	return c.begin();
...
inline auto buffer_sequence_end(
	const C& c, typename enable_if<!is_convertible<const C*, const mutable_buffer*>::value &&
								   !is_convertible<const C*, const const_buffer*>::value>::type* =
					0) ASIO_NOEXCEPT -> decltype(c.end()) {
	return c.end();
}
...
template <typename C>
inline typename C::iterator buffer_sequence_end(
	C& c, typename enable_if<!is_convertible<const C*, const mutable_buffer*>::value &&
							 !is_convertible<const C*, const const_buffer*>::value>::type* = 0)
	ASIO_NOEXCEPT {
	return c.end();
...
template <typename C>
inline typename C::const_iterator buffer_sequence_end(
	const C& c, typename enable_if<!is_convertible<const C*, const mutable_buffer*>::value &&
								   !is_convertible<const C*, const const_buffer*>::value>::type* =
					0) ASIO_NOEXCEPT {
	return c.end();
...
inline std::size_t buffer_size(one_buffer, Iterator begin, Iterator) ASIO_NOEXCEPT {
...
inline std::size_t buffer_size(const BufferSequence& b) ASIO_NOEXCEPT {
	return detail::buffer_size(detail::buffer_sequence_cardinality<BufferSequence>(),
							   asio::buffer_sequence_begin(b), asio::buffer_sequence_end(b));
}
 ...
 */
inline mutable_buffer operator+(const mutable_buffer& b, std::size_t n) ASIO_NOEXCEPT {
 ...
 * @relates mutable_buffer
 */
inline mutable_buffer operator+(std::size_t n, const mutable_buffer& b) ASIO_NOEXCEPT {
	return b + n;
}
 ...
 */
inline const_buffer operator+(const const_buffer& b, std::size_t n) ASIO_NOEXCEPT {
	std::size_t offset = n < b.size() ? n : b.size();
 ...
 * @relates const_buffer
 */
inline const_buffer operator+(std::size_t n, const const_buffer& b) ASIO_NOEXCEPT { return b + n; }
...
inline ASIO_MUTABLE_BUFFER buffer(const mutable_buffer& b,
	...
	return ASIO_MUTABLE_BUFFER(mutable_buffer(
		b.data(), b.size() < max_size_in_bytes ? b.size() : max_size_in_bytes
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
		,
		b.get_debug_check()
#endif // ASIO_ENABLE_BUFFER_DEBUGGING
 ...
 */
inline ASIO_MUTABLE_BUFFER buffer(void* data, std::size_t size_in_bytes) ASIO_NOEXCEPT {
 ...
 */
inline ASIO_CONST_BUFFER buffer(const void* data, std::size_t size_in_bytes) ASIO_NOEXCEPT {
 ...
 */
template <typename PodType, std::size_t N>
inline ASIO_MUTABLE_BUFFER buffer(PodType (&data)[N], std::size_t max_size_in_bytes) ASIO_NOEXCEPT {
	return ASIO_MUTABLE_BUFFER(
		data, N * sizeof(PodType) < max_size_in_bytes ? N * sizeof(PodType) : max_size_in_bytes);
}
...
template <typename PodType, std::size_t N>
inline typename detail::buffer_types<PodType>::container_type buffer(boost::array<PodType, N>& data)
	ASIO_NOEXCEPT {
	typedef typename asio::detail::buffer_types<PodType>::buffer_type buffer_type;
	typedef typename asio::detail::buffer_types<PodType>::container_type container_type;
	return container_type(buffer_type(data.c_array(), data.size() * sizeof(PodType)));
}

template <typename PodType, std::size_t N>
inline typename detail::buffer_types<PodType>::container_type buffer(
	boost::array<PodType, N>& data, std::size_t max_size_in_bytes) ASIO_NOEXCEPT {
	typedef typename asio::detail::buffer_types<PodType>::buffer_type buffer_type;
	typedef typename asio::detail::buffer_types<PodType>::container_type container_type;
 ...
 */
template <typename PodType, std::size_t N>
inline ASIO_MUTABLE_BUFFER buffer(boost::array<PodType, N>& data) ASIO_NOEXCEPT {
...
inline ASIO_MUTABLE_BUFFER buffer(boost::array<PodType, N>& data,
								  std::size_t max_size_in_bytes) ASIO_NOEXCEPT {
	return ASIO_MUTABLE_BUFFER(data.c_array(), data.size() * sizeof(PodType) < max_size_in_bytes
												   ? data.size() * sizeof(PodType)
												   : max_size_in_bytes);
}
 ...
 */
template <typename PodType, std::size_t N>
inline ASIO_CONST_BUFFER buffer(boost::array<const PodType, N>& data) ASIO_NOEXCEPT {
...
inline ASIO_CONST_BUFFER buffer(boost::array<const PodType, N>& data,
								std::size_t max_size_in_bytes) ASIO_NOEXCEPT {
	return ASIO_CONST_BUFFER(data.data(), data.size() * sizeof(PodType) < max_size_in_bytes
											  ? data.size() * sizeof(PodType)
											  : max_size_in_bytes);
}
 ...
 */
template <typename PodType, std::size_t N>
inline ASIO_CONST_BUFFER buffer(const boost::array<PodType, N>& data) ASIO_NOEXCEPT {
	return ASIO_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline ASIO_MUTABLE_BUFFER buffer(std::array<PodType, N>& data) ASIO_NOEXCEPT {
...
inline ASIO_MUTABLE_BUFFER buffer(std::array<PodType, N>& data,
								  std::size_t max_size_in_bytes) ASIO_NOEXCEPT {
	return ASIO_MUTABLE_BUFFER(data.data(), data.size() * sizeof(PodType) < max_size_in_bytes
												? data.size() * sizeof(PodType)
												: max_size_in_bytes);
}
 ...
 */
template <typename PodType, std::size_t N>
inline ASIO_CONST_BUFFER buffer(std::array<const PodType, N>& data) ASIO_NOEXCEPT {
	return ASIO_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline ASIO_CONST_BUFFER buffer(const std::array<PodType, N>& data) ASIO_NOEXCEPT {
	return ASIO_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
...
inline ASIO_MUTABLE_BUFFER buffer(std::vector<PodType, Allocator>& data) ASIO_NOEXCEPT {
	return ASIO_MUTABLE_BUFFER(
...
inline ASIO_MUTABLE_BUFFER buffer(std::vector<PodType, Allocator>& data,
	...
	return ASIO_MUTABLE_BUFFER(
		data.size() ? &data[0] : 0,
		data.size() * sizeof(PodType) < max_size_in_bytes ? data.size() * sizeof(PodType)
														  : max_size_in_bytes
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
		,
		detail::buffer_debug_check<typename std::vector<PodType, Allocator>::iterator>(data.begin())
 ...
 */
template <typename PodType, typename Allocator>
inline ASIO_CONST_BUFFER buffer(const std::vector<PodType, Allocator>& data) ASIO_NOEXCEPT {
	return ASIO_CONST_BUFFER(
		data.size() ? &data[0] : 0, data.size() * sizeof(PodType)
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
										,
		detail::buffer_debug_check<typename std::vector<PodType, Allocator>::const_iterator>(
			data.begin())
#endif // ASIO_ENABLE_BUFFER_DEBUGGING
	);
}
...
inline ASIO_MUTABLE_BUFFER buffer(std::basic_string<Elem, Traits, Allocator>& data) ASIO_NOEXCEPT {
	return ASIO_MUTABLE_BUFFER(
		data.size() ? &data[0] : 0, data.size() * sizeof(Elem)
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
										,
		detail::buffer_debug_check<typename std::basic_string<Elem, Traits, Allocator>::iterator>(
			data.begin())
#endif // ASIO_ENABLE_BUFFER_DEBUGGING
	);
}
 ...
 */
template <typename Elem, typename Traits, typename Allocator>
inline ASIO_MUTABLE_BUFFER buffer(std::basic_string<Elem, Traits, Allocator>& data,
								  std::size_t max_size_in_bytes) ASIO_NOEXCEPT {
	return ASIO_MUTABLE_BUFFER(
		data.size() ? &data[0] : 0,
		data.size() * sizeof(Elem) < max_size_in_bytes ? data.size() * sizeof(Elem)
													   : max_size_in_bytes
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
		,
		detail::buffer_debug_check<typename std::basic_string<Elem, Traits, Allocator>::iterator>(
 ...
 */
template <typename Elem, typename Traits, typename Allocator>
inline ASIO_CONST_BUFFER buffer(const std::basic_string<Elem, Traits, Allocator>& data)
	ASIO_NOEXCEPT {
	return ASIO_CONST_BUFFER(
		data.data(), data.size() * sizeof(Elem)
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
						 ,
...
inline ASIO_CONST_BUFFER buffer(basic_string_view<Elem, Traits> data) ASIO_NOEXCEPT {
	return ASIO_CONST_BUFFER(
		data.size() ? &data[0] : 0, data.size() * sizeof(Elem)
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
										,
...
class dynamic_string_buffer {
   public:
	...
	explicit dynamic_string_buffer(
		...
		std::size_t maximum_size = (std::numeric_limits<std::size_t>::max)()) ASIO_NOEXCEPT
		: string_(s),
...
#if !defined(ASIO_NO_DYNAMIC_BUFFER_V1)
		if (size_ != (std::numeric_limits<std::size_t>::max)()) return size_;
#endif // !defined(ASIO_NO_DYNAMIC_BUFFER_V1)
	 ...
	 */
	std::size_t max_size() const ASIO_NOEXCEPT { return max_size_; }
...
template <typename Elem, typename Traits, typename Allocator>
inline dynamic_string_buffer<Elem, Traits, Allocator> dynamic_buffer(
	std::basic_string<Elem, Traits, Allocator>& data, std::size_t max_size) ASIO_NOEXCEPT {
 ...
 */
template <typename Elem, typename Allocator>
inline dynamic_vector_buffer<Elem, Allocator> dynamic_buffer(std::vector<Elem, Allocator>& data)
	ASIO_NOEXCEPT {
...
inline std::size_t buffer_copy_1(const mutable_buffer& target, const const_buffer& source) {
	...
	if (n > 0) memcpy(target.data(), source.data(), n);
	return n;
}

template <typename TargetIterator, typename SourceIterator>
inline std::size_t buffer_copy(one_buffer, one_buffer, TargetIterator target_begin, TargetIterator,
...
template <typename TargetIterator, typename SourceIterator>
std::size_t buffer_copy(one_buffer, multiple_buffers, TargetIterator target_begin, TargetIterator,
...
template <typename TargetIterator, typename SourceIterator>
std::size_t buffer_copy(multiple_buffers, one_buffer, TargetIterator target_begin,
...
template <typename TargetIterator, typename SourceIterator>
std::size_t buffer_copy(multiple_buffers, multiple_buffers, TargetIterator target_begin,
						TargetIterator target_end, SourceIterator source_begin,
...
std::size_t buffer_copy(multiple_buffers, multiple_buffers, TargetIterator target_begin,
						TargetIterator target_end, SourceIterator source_begin,
						SourceIterator source_end, std::size_t max_bytes_to_copy) ASIO_NOEXCEPT {
	std::size_t total_bytes_copied = 0;
	...
	while (total_bytes_copied != max_bytes_to_copy && target_iter != target_end &&
		...
		std::size_t bytes_copied = (buffer_copy_1)(
			target_buffer, asio::buffer(source_buffer, max_bytes_to_copy - total_bytes_copied));
		total_bytes_copied += bytes_copied;
...
inline std::size_t buffer_copy(const MutableBufferSequence& target,
	...
	return detail::buffer_copy(
		...
		asio::buffer_sequence_begin(target), asio::buffer_sequence_end(target),
		asio::buffer_sequence_begin(source), asio::buffer_sequence_end(source));
}
...
inline std::size_t buffer_copy(const MutableBufferSequence& target,
	...
	return detail::buffer_copy(
		...
		detail::buffer_sequence_cardinality<ConstBufferSequence>(),
		asio::buffer_sequence_begin(target), asio::buffer_sequence_end(target),
		asio::buffer_sequence_begin(source), asio::buffer_sequence_end(source), max_bytes_to_copy);
}
