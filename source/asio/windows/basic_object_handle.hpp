...
class basic_object_handle {
   public:
	 ...
	 * object handle.
	 */
	explicit basic_object_handle(const executor_type& ex) : impl_(ex) {}
	 ...
	 * constructor.
	 */
	basic_object_handle(basic_object_handle&& other) : impl_(std::move(other.impl_)) {}
