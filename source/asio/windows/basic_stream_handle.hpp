...
class basic_stream_handle : public basic_overlapped_handle<Executor> {
   public:
	 ...
	 * handle.
	 */
	explicit basic_stream_handle(const executor_type& ex) : basic_overlapped_handle<Executor>(ex) {}
   ...
   private:
	class initiate_async_write_some {
	   public:
		...
		explicit initiate_async_write_some(basic_stream_handle* self) : self_(self) {}
	...
	class initiate_async_read_some {
	   public:
		...
		explicit initiate_async_read_some(basic_stream_handle* self) : self_(self) {}
