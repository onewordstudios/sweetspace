   ...
   private:
	class initiate_async_send {
	   public:
		...
		explicit initiate_async_send(basic_datagram_socket* self) : self_(self) {}
	...
	class initiate_async_send_to {
	   public:
		...
		explicit initiate_async_send_to(basic_datagram_socket* self) : self_(self) {}
	...
	class initiate_async_receive {
	   public:
		...
		explicit initiate_async_receive(basic_datagram_socket* self) : self_(self) {}
	...
	class initiate_async_receive_from {
	   public:
		...
		explicit initiate_async_receive_from(basic_datagram_socket* self) : self_(self) {}
