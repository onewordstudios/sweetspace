...
class basic_descriptor : public descriptor_base {
   public:
	 ...
	 * descriptor.
	 */
	explicit basic_descriptor(const executor_type& ex) : impl_(ex) {}
	 ...
	 * constructor.
	 */
	basic_descriptor(basic_descriptor&& other) ASIO_NOEXCEPT : impl_(std::move(other.impl_)) {}
   ...
   private:
	...
	class initiate_async_wait {
	   public:
		...
		explicit initiate_async_wait(basic_descriptor* self) : self_(self) {}
