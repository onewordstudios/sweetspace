...
class io_context::executor_type {
   public:
	 ...
	 */
	friend bool operator==(const executor_type& a, const executor_type& b) ASIO_NOEXCEPT {
...
class service_base : public asio::io_context::service {
   public:
	...
	// Constructor.
	service_base(asio::io_context& io_context) : asio::io_context::service(io_context) {}
};
