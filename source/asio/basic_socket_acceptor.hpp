...
class basic_socket_acceptor : public socket_base {
   public:
...
#elif defined(ASIO_HAS_IOCP)
	typedef
		typename detail::win_iocp_socket_service<Protocol>::native_handle_type native_handle_type;
#else
	typedef
		typename detail::reactive_socket_service<Protocol>::native_handle_type native_handle_type;
#endif
	 ...
	 * acceptor.
	 */
	explicit basic_socket_acceptor(const executor_type& ex) : impl_(ex) {}
	 ...
	 */
	basic_socket_acceptor(const executor_type& ex, const protocol_type& protocol) : impl_(ex) {
		asio::error_code ec;
	...
	basic_socket_acceptor(const executor_type& ex, const endpoint_type& endpoint,
		...
		impl_.get_service().listen(impl_.get_implementation(), socket_base::max_listen_connections,
								   ec);
	...
	template <typename ExecutionContext>
	basic_socket_acceptor(
		ExecutionContext& context, const endpoint_type& endpoint, bool reuse_addr = true,
		typename enable_if<is_convertible<ExecutionContext&, execution_context&>::value>::type* = 0)
		: impl_(context) {
		asio::error_code ec;
		const protocol_type protocol = endpoint.protocol();
	 ...
	 * constructor.
	 */
	basic_socket_acceptor(basic_socket_acceptor&& other) : impl_(std::move(other.impl_)) {}
	...
	basic_socket_acceptor(basic_socket_acceptor<Protocol1, Executor1>&& other,
						  typename enable_if<is_convertible<Protocol1, Protocol>::value &&
											 is_convertible<Executor1, Executor>::value>::type* = 0)
		: impl_(std::move(other.impl_)) {}
	...
	executor_type get_executor() ASIO_NOEXCEPT { return impl_.get_executor(); }
	...
	ASIO_INITFN_AUTO_RESULT_TYPE(WaitHandler, void(asio::error_code))
	async_wait(wait_type w,
			   ASIO_MOVE_ARG(WaitHandler) handler ASIO_DEFAULT_COMPLETION_TOKEN(executor_type)) {
		return async_initiate<WaitHandler, void(asio::error_code)>(initiate_async_wait(this),
																   handler, w);
	}
	...
	void accept(basic_socket<Protocol1, Executor1>& peer,
		...
		asio::error_code ec;
		impl_.get_service().accept(impl_.get_implementation(), peer, static_cast<endpoint_type*>(0),
								   ec);
	...
	ASIO_INITFN_AUTO_RESULT_TYPE(AcceptHandler, void(asio::error_code))
	async_accept(basic_socket<Protocol1, Executor1>& peer,
				 ASIO_MOVE_ARG(AcceptHandler) handler ASIO_DEFAULT_COMPLETION_TOKEN(executor_type),
				 typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0) {
		return async_initiate<AcceptHandler, void(asio::error_code)>(
			initiate_async_accept(this), handler, &peer, static_cast<endpoint_type*>(0));
	}
	 ...
	 */
	template <typename Executor1>
	void accept(basic_socket<protocol_type, Executor1>& peer, endpoint_type& peer_endpoint) {
		asio::error_code ec;
	 ...
	 * manner equivalent to using asio::post().
	 */
	template <typename Executor1, ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code)) AcceptHandler
									  ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(executor_type)>
	ASIO_INITFN_AUTO_RESULT_TYPE(AcceptHandler, void(asio::error_code))
	async_accept(basic_socket<protocol_type, Executor1>& peer, endpoint_type& peer_endpoint,
				 ASIO_MOVE_ARG(AcceptHandler)
					 handler ASIO_DEFAULT_COMPLETION_TOKEN(executor_type)) {
		return async_initiate<AcceptHandler, void(asio::error_code)>(
	...
	typename Protocol::socket::template rebind_executor<executor_type>::other accept() {
		asio::error_code ec;
		typename Protocol::socket::template rebind_executor<executor_type>::other peer(
			impl_.get_executor());
	...
	template <ASIO_COMPLETION_TOKEN_FOR(
		void(asio::error_code,
			 typename Protocol::socket::template rebind_executor<executor_type>::other))
				  MoveAcceptHandler ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(executor_type)>
	ASIO_INITFN_AUTO_RESULT_TYPE(
		MoveAcceptHandler,
		void(asio::error_code,
			 typename Protocol::socket::template rebind_executor<executor_type>::other))
	async_accept(ASIO_MOVE_ARG(MoveAcceptHandler)
					 handler ASIO_DEFAULT_COMPLETION_TOKEN(executor_type)) {
		return async_initiate<
			MoveAcceptHandler,
			void(asio::error_code,
				 typename Protocol::socket::template rebind_executor<executor_type>::other)>(
			initiate_async_move_accept(this), handler, impl_.get_executor(),
			static_cast<endpoint_type*>(0),
			static_cast<typename Protocol::socket::template rebind_executor<executor_type>::other*>(
				0));
	}
	 ...
	 */
	template <typename Executor1>
	typename Protocol::socket::template rebind_executor<Executor1>::other accept(
		const Executor1& ex, typename enable_if<is_executor<Executor1>::value>::type* = 0) {
		asio::error_code ec;
	...
	template <typename Executor1>
	typename Protocol::socket::template rebind_executor<Executor1>::other accept(
		const Executor1& ex, asio::error_code& ec,
	...
	async_accept(const Executor1& ex,
				 ASIO_MOVE_ARG(MoveAcceptHandler)
					 handler ASIO_DEFAULT_COMPLETION_TOKEN(executor_type),
				 typename enable_if<is_executor<Executor1>::value>::type* = 0) {
		typedef
			typename Protocol::socket::template rebind_executor<Executor1>::other other_socket_type;

		return async_initiate<MoveAcceptHandler, void(asio::error_code, other_socket_type)>(
			initiate_async_move_accept(this), handler, ex, static_cast<endpoint_type*>(0),
	...
	async_accept(
		ExecutionContext& context,
		ASIO_MOVE_ARG(MoveAcceptHandler) handler ASIO_DEFAULT_COMPLETION_TOKEN(executor_type),
		typename enable_if<is_convertible<ExecutionContext&, execution_context&>::value>::type* =
			0) {
		...
		return async_initiate<MoveAcceptHandler, void(asio::error_code, other_socket_type)>(
			initiate_async_move_accept(this), handler, context.get_executor(),
			static_cast<endpoint_type*>(0), static_cast<other_socket_type*>(0));
	}
	...
	async_accept(endpoint_type& peer_endpoint,
		...
		return async_initiate<
			...
			void(asio::error_code,
				 typename Protocol::socket::template rebind_executor<executor_type>::other)>(
			initiate_async_move_accept(this), handler, impl_.get_executor(), &peer_endpoint,
			static_cast<typename Protocol::socket::template rebind_executor<executor_type>::other*>(
				0));
	}
	...
	template <typename Executor1>
	typename Protocol::socket::template rebind_executor<Executor1>::other accept(
		const executor_type& ex, endpoint_type& peer_endpoint, asio::error_code& ec,
		typename enable_if<is_executor<Executor1>::value>::type* = 0) {
		typename Protocol::socket::template rebind_executor<Executor1>::other peer(ex);
		impl_.get_service().accept(impl_.get_implementation(), peer, &peer_endpoint, ec);
		return peer;
	...
	typename Protocol::socket::template rebind_executor<
		typename ExecutionContext::executor_type>::other
	accept(ExecutionContext& context, endpoint_type& peer_endpoint, asio::error_code& ec,
		   typename enable_if<is_convertible<ExecutionContext&, execution_context&>::value>::type* =
			   0) {
		typename Protocol::socket::template rebind_executor<
			typename ExecutionContext::executor_type>::other peer(context);
	...
	async_accept(const Executor1& ex, endpoint_type& peer_endpoint,
		...
		return async_initiate<MoveAcceptHandler, void(asio::error_code, other_socket_type)>(
			initiate_async_move_accept(this), handler, ex, &peer_endpoint,
			static_cast<other_socket_type*>(0));
	}
	...
	ASIO_INITFN_AUTO_RESULT_TYPE(MoveAcceptHandler,
								 void(asio::error_code,
									  typename Protocol::socket::template rebind_executor<
										  typename ExecutionContext::executor_type>::other))
	async_accept(
		ExecutionContext& context, endpoint_type& peer_endpoint,
		ASIO_MOVE_ARG(MoveAcceptHandler) handler ASIO_DEFAULT_COMPLETION_TOKEN(executor_type),
		typename enable_if<is_convertible<ExecutionContext&, execution_context&>::value>::type* =
			0) {
		typedef typename Protocol::socket::template rebind_executor<
		...
		return async_initiate<MoveAcceptHandler, void(asio::error_code, other_socket_type)>(
			initiate_async_move_accept(this), handler, context.get_executor(), &peer_endpoint,
			static_cast<other_socket_type*>(0));
	}
#endif // defined(ASIO_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)
   ...
   private:
	...
	basic_socket_acceptor& operator=(const basic_socket_acceptor&) ASIO_DELETED;

	class initiate_async_wait {
	   public:
		typedef Executor executor_type;

		explicit initiate_async_wait(basic_socket_acceptor* self) : self_(self) {}

		executor_type get_executor() const ASIO_NOEXCEPT { return self_->get_executor(); }
		...
		void operator()(ASIO_MOVE_ARG(WaitHandler) handler, wait_type w) const {
			...
			self_->impl_.get_service().async_wait(self_->impl_.get_implementation(), w,
												  handler2.value,
	...
	class initiate_async_accept {
	   public:
		...
		explicit initiate_async_accept(basic_socket_acceptor* self) : self_(self) {}
		...
		void operator()(ASIO_MOVE_ARG(AcceptHandler) handler,
			...
			self_->impl_.get_service().async_accept(self_->impl_.get_implementation(), *peer,
													peer_endpoint, handler2.value,
													self_->impl_.get_implementation_executor());
		}
	...
	class initiate_async_move_accept {
	   public:
		...
		explicit initiate_async_move_accept(basic_socket_acceptor* self) : self_(self) {}

		executor_type get_executor() const ASIO_NOEXCEPT { return self_->get_executor(); }

		template <typename MoveAcceptHandler, typename Executor1, typename Socket>
		void operator()(ASIO_MOVE_ARG(MoveAcceptHandler) handler, const Executor1& peer_ex,
			...
			self_->impl_.get_service().async_move_accept(
				self_->impl_.get_implementation(), peer_ex, peer_endpoint, handler2.value,
				self_->impl_.get_implementation_executor());
		}
