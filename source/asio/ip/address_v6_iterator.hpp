...
class basic_address_iterator<address_v6> {
   public:
	...
	basic_address_iterator(const address_v6& addr) ASIO_NOEXCEPT : address_(addr) {}
	...
	basic_address_iterator& operator=(basic_address_iterator&& other) ASIO_NOEXCEPT {
		address_ = ASIO_MOVE_CAST(address_v6)(other.address_);
		return *this;
	}
#endif // defined(ASIO_HAS_MOVE)
	...
	const address_v6& operator*() const ASIO_NOEXCEPT { return address_; }
