...
class address_v4 {
   public:
	...
	/// Default constructor.
	address_v4() ASIO_NOEXCEPT { addr_.s_addr = 0; }
	...
	/// Copy constructor.
	address_v4(const address_v4& other) ASIO_NOEXCEPT : addr_(other.addr_) {}

#if defined(ASIO_HAS_MOVE)
	/// Move constructor.
	address_v4(address_v4&& other) ASIO_NOEXCEPT : addr_(other.addr_) {}
	...
	static address_v4 any() ASIO_NOEXCEPT { return address_v4(); }

	/// Obtain an address object that represents the loopback address.
	static address_v4 loopback() ASIO_NOEXCEPT { return address_v4(0x7F000001); }

	/// Obtain an address object that represents the broadcast address.
	static address_v4 broadcast() ASIO_NOEXCEPT { return address_v4(0xFFFFFFFF); }
 ...
 * @relates address_v4
 */
ASIO_DECL address_v4 make_address_v4(string_view str, asio::error_code& ec) ASIO_NOEXCEPT;
