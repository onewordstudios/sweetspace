...
class address {
   public:
	...
	bool is_v4() const ASIO_NOEXCEPT { return type_ == ipv4; }

	/// Get whether the address is an IP version 6 address.
	bool is_v6() const ASIO_NOEXCEPT { return type_ == ipv6; }
	...
	/// Compare addresses for ordering.
	friend bool operator>(const address& a1, const address& a2) ASIO_NOEXCEPT { return a2 < a1; }
 ...
 * @relates address
 */
ASIO_DECL address make_address(string_view str, asio::error_code& ec) ASIO_NOEXCEPT;
