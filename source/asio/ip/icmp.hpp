...
class icmp {
   public:
	...
	static icmp v4() ASIO_NOEXCEPT { return icmp(ASIO_OS_DEF(IPPROTO_ICMP), ASIO_OS_DEF(AF_INET)); }
	...
	int type() const ASIO_NOEXCEPT { return ASIO_OS_DEF(SOCK_RAW); }
   ...
   private:
	...
	explicit icmp(int protocol_id, int protocol_family) ASIO_NOEXCEPT : protocol_(protocol_id),
