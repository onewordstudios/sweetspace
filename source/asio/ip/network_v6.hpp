...
class network_v6 {
   public:
	...
	/// Copy constructor.
	network_v6(const network_v6& other) ASIO_NOEXCEPT : address_(other.address_),
	...
	address_v6 address() const ASIO_NOEXCEPT { return address_; }
	...
	network_v6 canonical() const ASIO_NOEXCEPT { return network_v6(network(), prefix_length()); }

	/// Test if network is a valid host address.
	bool is_host() const ASIO_NOEXCEPT { return prefix_length_ == 128; }
