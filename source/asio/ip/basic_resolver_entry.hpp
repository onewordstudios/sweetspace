...
class basic_resolver_entry {
   public:
	...
	basic_resolver_entry(const endpoint_type& ep, ASIO_STRING_VIEW_PARAM host,
	...
	std::basic_string<char, std::char_traits<char>, Allocator> host_name(
		...
		return std::basic_string<char, std::char_traits<char>, Allocator>(host_name_.c_str(),
																		  alloc);
	}
	...
	std::basic_string<char, std::char_traits<char>, Allocator> service_name(
		const Allocator& alloc = Allocator()) const {
		return std::basic_string<char, std::char_traits<char>, Allocator>(service_name_.c_str(),
																		  alloc);
	}
