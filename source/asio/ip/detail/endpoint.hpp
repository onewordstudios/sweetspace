...
class endpoint {
   public:
	...
	// Copy constructor.
	endpoint(const endpoint& other) ASIO_NOEXCEPT : data_(other.data_) {}
	...
	asio::detail::socket_addr_type* data() ASIO_NOEXCEPT { return &data_.base; }

	// Get the underlying endpoint in the native type.
	const asio::detail::socket_addr_type* data() const ASIO_NOEXCEPT { return &data_.base; }
	...
	std::size_t capacity() const ASIO_NOEXCEPT { return sizeof(data_); }
	...
	bool is_v4() const ASIO_NOEXCEPT { return data_.base.sa_family == ASIO_OS_DEF(AF_INET); }
