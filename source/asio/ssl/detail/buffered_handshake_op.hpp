...
class buffered_handshake_op {
   public:
	...
	engine::want operator()(engine& eng, asio::error_code& ec,
		...
		return this->process(eng, ec, bytes_transferred, asio::buffer_sequence_begin(buffers_),
   ...
   private:
	...
	engine::want process(engine& eng, asio::error_code& ec, std::size_t& bytes_transferred,
