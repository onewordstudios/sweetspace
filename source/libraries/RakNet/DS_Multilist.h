...
#define DEFINE_MULTILIST_PTR_TO_MEMBER_COMPARISONS(_CLASS_NAME_, _KEY_TYPE_, \
												   _MEMBER_VARIABLE_NAME_)   \
	bool operator<(const DataStructures::MLKeyRef<_KEY_TYPE_> &inputKey,     \
...
class RAK_DLL_EXPORT Multilist {
   public:
	...
	void Push(const _DataType &d, const _KeyType &key, const char *file = __FILE__,
	...
	void PushOpposite(const _DataType &d, const char *file = __FILE__,
					  unsigned int line = __LINE__);
	...
	void InsertAtIndex(const _DataType &d, _IndexType index, const char *file = __FILE__,
					   unsigned int line = __LINE__);
	...
	void RemoveAtIndex(_IndexType position, const char *file = __FILE__,
					   unsigned int line = __LINE__);

	/// \brief Find the index of \a key, and remove at that index.
	bool RemoveAtKey(_KeyType key, bool assertIfDoesNotExist, const char *file = __FILE__,
					 unsigned int line = __LINE__);
	...
	void ForEach(void (*func)(_DataType &item, const char *file, unsigned int line),
	...
	void Clear(bool deallocateSmallBlocks = true, const char *file = __FILE__,
			   unsigned int line = __LINE__);
	...
	void ClearPointers(bool deallocateSmallBlocks = true, const char *file = __FILE__,
					   unsigned int line = __LINE__);
	...
	/// return different results Once the list is sorted, further operations to lookup by key will
	/// be log2(n) until the list is modified
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
_DataType &Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::operator[](
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
_DataType &Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::Pop(const char *file,
																		   unsigned int line) {
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::InsertAtIndex(const _DataType &d,
																			   _IndexType index,
																			   const char *file,
																			   unsigned int line) {
	ReallocateIfNeeded(file, line);
...
bool Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::RemoveAtKey(
	_KeyType key, bool assertIfDoesNotExist, const char *file, unsigned int line) {
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
_IndexType Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::GetIndexOf(
	_KeyType key) const {
	_IndexType i;
	if (IsSorted()) {
		bool objectExists;
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
_IndexType Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::GetInsertionIndex(
	_KeyType key) const {
	_IndexType i;
	if (IsSorted()) {
		bool objectExists;
...
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::ForEach(
	void (*func)(_DataType &item, const char *file, unsigned int line), const char *file,
	unsigned int line) {
	_IndexType i;
...
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::ClearPointers(
	bool deallocateSmallBlocks, const char *file, unsigned int line) {
	_IndexType i;
...
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::QSortAscending(
	_IndexType leftEdge, _IndexType rightEdge) {
	_DataType temp;
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::QSortDescending(
	_IndexType leftEdge, _IndexType rightEdge) {
	_DataType temp;
	_IndexType left = leftEdge;
	_IndexType right = rightEdge;
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
MultilistType Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::GetMultilistType(
	void) const {
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::SetMultilistType(
	MultilistType newType) {
...
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::FindIntersection(
	Multilist &source1, Multilist &source2, Multilist &intersection, Multilist &uniqueToSource1,
...
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::ReallocToSize(
	_IndexType newAllocationSize, const char *file, unsigned int line) {
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::InsertInOrderedList(
	const _DataType &d, const _KeyType &key) {
	RakAssert(GetMultilistType() == ML_ORDERED_LIST);
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::InsertShiftArrayRight(
	const _DataType &d, _IndexType index) {
...
template <const MultilistType _MultilistType, class _DataType, class _KeyType, class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::DeleteShiftArrayLeft(
	_IndexType index) {
