...
to return data virtual int RakNetRecvFrom( char dataOut[ MAXIMUM_MTU_SIZE ], SystemAddress
...
// 		static void RecvFromBlockingIPV4And6( RakNetSocket *s, RakPeer *rakPeer, char *dataOut, int
// *bytesReadOut, SystemAddress *systemAddressOut, RakNet::TimeUS *timeRead ); 	#endif
...
// int *bytesReadOut, SystemAddress *systemAddressOut, RakNet::TimeUS *timeRead );
	...
	static RakNet::RakString GetSubNetForSocketAndIp(__UDPSOCKET__ inSock,
	...
	// setBroadcast);
	static void SetSocketOptions(__UDPSOCKET__ listenSocket, bool blockingSocket,
								 bool setBroadcast);
