...
struct RAK_DLL_EXPORT ThreadPool {
	...
	void AddInput(OutputType (*workerThreadCallback)(InputType, bool *returnOutput,
													 void *perThreadData),
				  InputType inputData);
	...
	/// Unlock the input buffer after you are done with the functions InputSize, GetInputAtIndex,
	/// and RemoveInputAtIndex
...
void ThreadPool<InputType, OutputType>::AddInput(
	OutputType (*workerThreadCallback)(InputType, bool *returnOutput, void *perThreadData),
	InputType inputData) {
