...
class RakNetSocket2 {
   public:
	...
	virtual RNS2SendResult Send(RNS2_SendParameters *sendParameters, const char *file,
								unsigned int line) = 0;
...
class RNS2_WindowsStore8 : public RakNetSocket2 {
   public:
	...
	static int WinRTSetSockOpt(Windows::Networking::Sockets::DatagramSocket ^ s, int level,
							   int optname, const char *optval, socklen_t optlen);

	static int WinRTIOCTLSocket(Windows::Networking::Sockets::DatagramSocket ^ s, long cmd,
								unsigned long *argp);
...
class RNS2_NativeClient : public RakNetSocket2 {
   public:
	...
	RNS2BindResult Bind(NativeClientBindParameters *bindParameters, const char *file,
						unsigned int line);
   ...
   protected:
	...
	static RNS2_SendParameters_NativeClient *CloneSP(RNS2_SendParameters *sp,
													 RNS2_NativeClient *socket2, const char *file,
													 unsigned int line);
...
class IRNS2_Berkley : public RakNetSocket2 {
   public:
	...
	// ----------- MEMBERS ------------
	virtual RNS2BindResult Bind(RNS2_BerkleyBindParameters *bindParameters, const char *file,
								unsigned int line) = 0;
};
...
class RNS2_Berkley : public IRNS2_Berkley {
   ...
   protected:
	...
	RNS2BindResult BindShared(RNS2_BerkleyBindParameters *bindParameters, const char *file,
							  unsigned int line);
	RNS2BindResult BindSharedIPV4(RNS2_BerkleyBindParameters *bindParameters, const char *file,
								  unsigned int line);
	RNS2BindResult BindSharedIPV4And6(RNS2_BerkleyBindParameters *bindParameters, const char *file,
									  unsigned int line);
...
class RNS2_Windows_Linux_360 {
   public:
   protected:
	static RNS2SendResult Send_Windows_Linux_360NoVDP(RNS2Socket rns2Socket,
...
class RAK_DLL_EXPORT SocketLayerOverride {
   public:
	...
	// to return data
	virtual int RakNetRecvFrom(char dataOut[MAXIMUM_MTU_SIZE], SystemAddress *senderOut,
...
class RNS2_Windows : public RNS2_Berkley, public RNS2_Windows_Linux_360 {
   public:
	...
	RNS2BindResult Bind(RNS2_BerkleyBindParameters *bindParameters, const char *file,
						unsigned int line);
	RNS2SendResult Send(RNS2_SendParameters *sendParameters, const char *file, unsigned int line);
