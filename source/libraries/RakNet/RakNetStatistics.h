...
enum RNSPerSecondMetrics {
	...
	/// How many user message bytes were resent. A message is resent if it is marked as reliable,
	/// and either the message didn't arrive or the message ack didn't arrive.
