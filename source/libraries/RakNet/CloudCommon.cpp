...
void CloudQueryResult::SerializeNumRows(bool writeToBitstream, uint32_t &numRows,
										BitStream *bitStream) {
	bitStream->Serialize(writeToBitstream, numRows);
}
void CloudQueryResult::SerializeCloudQueryRows(bool writeToBitstream, uint32_t &numRows,
