...
class RAK_DLL_EXPORT RackspaceEventCallback_Default : public Rackspace2EventCallback {
   public:
	virtual void ExecuteDefault(const char *callbackName, RackspaceEventType eventType,
...
class RAK_DLL_EXPORT Rackspace {
   public:
	...
	/// calling AddOperation() manually. See the implementation of CreateServer for how to do so.
	/// The server takes a while to build. Call GetServerDetails() to get the current build status.
	...
	/// alphanumeric characters, periods, and hyphens are valid. Server Name cannot start or end
	/// with a period or hyphen. \param[in] imageId Which image (harddrive contents, including OS)
	/// to use \param[in] flavorId Which flavor (hardware config) to use, primarily how much memory
	/// is available.
	...
	/// \param[in] serverId Which server to operate on. You can call ListServers() to get the list
	/// of active servers.
	...
	/// \param[in] serverId Which server to operate on. You can call ListServers() to get the list
	/// of active servers. \param[in] ipAddress Which IP address. You can call ListServerAddresses()
	...
	/// \param[in] serverId Which server to operate on. You can call ListServers() to get the list
	/// of active servers. \param[in] rebootType Should be either "HARD" or "SOFT"
	...
	/// \param[in] serverId Which server to operate on. You can call ListServers() to get the list
	/// of active servers. \param[in] imageId Which image (harddrive contents, including OS) to use
	...
	/// \brief List all images (software configs, including operating systems), which includes
	/// images you create yourself \sa
	/// http://docs.rackspacecloud.com/servers/api/v1.0/cs-devguide-20110112.pdf \sa
