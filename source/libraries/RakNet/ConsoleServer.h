...
class RAK_DLL_EXPORT ConsoleServer {
   public:
	...
	/// and receive commands \param[in] transportInterface Your interface to use. \param[in] port
	/// The port to host on.  Telnet uses port 23 by default.  RakNet can use whatever you want.
